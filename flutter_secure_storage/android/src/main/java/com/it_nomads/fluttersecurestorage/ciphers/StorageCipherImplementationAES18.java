...
/**
 * Legacy AES/CBC/PKCS7Padding storage cipher used by the plugin prior to v10.
 *
 * <p>Kept only so data encrypted with {@code AES_CBC_PKCS7Padding} (v9.x and earlier) can still
 * be decrypted and migrated to the current storage cipher. It must not be used to encrypt new
 * data.
 */
